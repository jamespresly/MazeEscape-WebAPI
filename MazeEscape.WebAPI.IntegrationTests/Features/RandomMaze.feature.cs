...
namespace MazeEscape.WebAPI.IntegrationTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("RandomMaze")]
    public partial class RandomMazeFeature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "RandomMaze", "Enpoint usage for creating a random maze", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
#line 10
 testRunner.And("the response data contains an int named:width with value:10", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 11
 testRunner.And("the response data contains an int named:height with value:10", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
...
#line hidden
#line 17
 testRunner.And("the response contains error message:width and height are required parameters", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line hidden
#line 23
 testRunner.And("the response contains error message:width and height must be between 10 and 50", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
